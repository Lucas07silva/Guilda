-- 1) DROP TABLES (Ordem: Filhas primeiro, depois Pais)
...
(10, 'Starscourge Greatsword', 'Legendary', 1), (11, 'Buckler', 'Common', 1), (12, 'Fingerprint Shield', 'Epic', 1),
(13, 'Comet Azur', 'Epic', 1), (14, 'Elianora Poleblade', 'Epic', 1), (15, 'White Mask', 'Rare', 1),
-- Itens Cyberpunk 2077
(16, 'Mantis Blades', 'Epic', 2), (17, 'Monowire', 'Epic', 2), (18, 'Johnny Silverhand Jacket', 'Legendary', 2),
(19, 'Malorian Arms 3516', 'Legendary', 2), (20, 'Sandevistan Mk.4', 'Legendary', 2), (21, 'Kiroshi Optics', 'Common', 2),
(22, 'Arasaka Neural Link', 'Rare', 2), (23, 'Gorilla Arms', 'Epic', 2), (24, 'Projectile Launch System', 'Epic', 2),
(25, 'Satori Katana', 'Legendary', 2), (26, 'Lizzie Pistol', 'Rare', 2), (27, 'Widow Maker', 'Epic', 2),
(28, 'Skippy AI Gun', 'Legendary', 2), (29, 'Netwatch Driver', 'Rare', 2), (30, 'Trauma Team Medkit', 'Uncommon', 2);
...
-- MERCADO HISTORICO
INSERT INTO mercado_historico (id, id_item_base, valor_venda) VALUES
(1,1,240.00), (2,16,170.00), (3,2,145.00), (4,17,480.00), (5,3,110.00), (6,18,290.00),
(7,4,440.00), (8,19,580.00), (9,5,45.00), (10,20,380.00), (11,6,10.00), (12,21,20.00),
(13,7,75.00), (14,22,85.00), (15,8,300.00), (16,23,130.00), (17,9,100.00), (18,24,200.00),
(19,10,430.00), (20,25,540.00), (21,11,10.00), (22,26,15.00), (23,12,180.00), (24,27,210.00),
(25,13,580.00), (26,28,40.00), (27,14,80.00), (28,29,950.00), (29,15,30.00), (30,30,8.00);

-- OFERTA TROCA
INSERT INTO oferta_troca (id, id_remetente, id_destinatario, status) VALUES
(1,1,2,'CONCLUIDA'), (2,3,4,'PENDENTE'), (3,5,6,'CANCELADA'), (4,7,8,'CONCLUIDA'), (5,9,10,'PENDENTE'),
(6,11,12,'PENDENTE'), (7,13,14,'PENDENTE'), (8,15,16,'PENDENTE'), (9,17,18,'PENDENTE'), (10,19,20,'PENDENTE'),
(11,21,22,'PENDENTE'), (12,23,24,'PENDENTE'), (13,25,26,'PENDENTE'), (14,27,28,'PENDENTE'), (15,29,30,'PENDENTE'),
(16,2,1,'PENDENTE'), (17,4,3,'PENDENTE'), (18,6,5,'PENDENTE'), (19,8,7,'PENDENTE'), (20,10,9,'PENDENTE'),
(21,12,11,'PENDENTE'), (22,14,13,'PENDENTE'), (23,16,15,'PENDENTE'), (24,18,17,'PENDENTE'), (25,20,19,'PENDENTE'),
(26,22,21,'PENDENTE'), (27,24,23,'PENDENTE'), (28,26,25,'PENDENTE'), (29,28,27,'PENDENTE'), (30,30,29,'PENDENTE');

-- ITEM OFERTA TROCA
INSERT INTO item_oferta_troca (id_oferta, id_inventario_item) VALUES
...
(1, 'Elden Lord', 1000, 1),
(2, 'Shards Bearer', 500, 1),
(3, 'Night City Legend', 1000, 2),
(4, 'Cyberpsycho Hunter', 450, 2);
